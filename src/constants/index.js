...
export const calculateSizes = (isSmall, isMobile, isTablet) => {
    return {
        ...
        deskPosition: isSmall ? [-0.5, 2, 0] : isMobile ? [-0.5, -1, 0] : [-0.5, -8, 0],
        powerBIScale: isSmall ? 0.2 : isMobile ? 0.4 : 0.5,
        powerBIPosition: isSmall ? [4, 4, 0] : isMobile ? [6, 4, 0] : isTablet ? [10, 4, 0] : [12, 3, 0],
        ...
        reactLogoPosition: isSmall ? [10, -4, 0] : isMobile ? [10, -4, 0] : isTablet ? [10, -4, 0] : [10, -4, 0],
